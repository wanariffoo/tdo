...
// #include "disc/poisson_disc.h"
			...
			// /home/arif/Codes/PSFEM/local/psfem/src/algebra/lil_matrix.h:92:41: 
			// error: ‘typename LILMatrix<T>::RowIterator’ names ‘template<class T> template<class ValueType, class IndexType> class LILMatrix<T>::RowIterator’
			// which is not a type
...
#include "algebra/lil_matrix.h"				// problem-o
// #include "algebra/ell_matrix_cuda.h"			// problem-o

// #include "solver/iterative_solver.h"			// problem-o
// #include "solver/cg.h"						// problem-o

// #include "precond/jacobi.h"					// problem-o
...
// 	linSolver.set_convergence_params(100, 1e-99, 1e-10);
