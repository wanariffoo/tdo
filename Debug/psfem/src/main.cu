...
// 	// output timing
// 	if(mpi::world().rank() == 0) {
// 		printf("Assembling took:  %12.6e s\n", (stopAssemble-startAssemble) );
// 		printf("Solver init took: %12.6e s\n", (stopInitSolver-startInitSolver) );
// 		printf("Solver application took: %12.6e s\n", (stopSolver-startSolver) );
// 	}
	
	
// 	// DEBUG:
	
// 	cout << "BEFORE x.norm() = " << temp_x << endl;
...
// 	if(!linSolver.deallocation_GPU())
// 		cout << "Deallocation of device memory of the linear solver failed!" << endl;
	
// 	if(!BaseSolver.deallocation_GPU())
// 		cout << "Deallocation of device memory of the base solver failed!" << endl;
